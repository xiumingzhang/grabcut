...
public:
	...
	void add_term2(Var x, Var y, Value W);
	...
	TotalValue minimize(bool incremental = false, Block<Var>* changed_list = NULL);
	...
	int var_num() { return GraphT::get_node_num(); }
